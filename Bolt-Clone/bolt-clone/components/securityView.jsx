import {securityData} from "./extendedMenuData"
import SecurityViewContent from "@components/securityViewContent";
            ...
            <div className="grid grid-flow-row w-[95%]">
                <div className="grid grid-cols-3 gap-y-10">
                    {securityData.map((element, index) => (
                        <SecurityViewContent key={index} title={element.title} item={element.items.map((items, index) => (
