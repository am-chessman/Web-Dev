import {earnData} from "./extendedMenuData"
import EarnViewContent from "@components/earnViewContent";
        ...
        <>
            <div className="grid grid-flow-row w-[95%]">
                <div className="grid grid-cols-3 gap-y-10">
                    {earnData.map((element, index) => (
                        <EarnViewContent key={index} title={element.title} item={element.items.map((items, index) => (
