import {citiesData} from "./extendedMenuData"
import CitiesViewContent from "@components/citiesViewContent";
import citiesViewContent from "@components/citiesViewContent";
            ...
            <div className="grid grid-flow-row w-[95%]">
                <div className="grid grid-cols-3 gap-y-10">
                    {citiesData.map((element, index) => (
                        <CitiesViewContent key={index} title={element.title} item={element.items.map((items, index) => (
