    ...
    return (
        <>
            <nav className="bg-black">
                <div className="flex justify-between align-middle items-center pt-6 pb-6 pr-20 pl-20">
                    <div>
                    ...
                    <div className="flex flex-row justify-center items-center gap-10 font-GalanoClassic">
                        ...
                        <div>
                            <button className="text-white text-3xl font-bold outline-none border-none">
